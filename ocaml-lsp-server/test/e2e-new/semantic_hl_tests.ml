...
module type S = sig
  ...
  [%expect
    {|
    let <function|definition-0>f</0> ~<parameter|labeled-1>labeled</1> ?(<parameter|optional-2>optional</2> = <number|-3>1</3>) <parameter|-4>unlabeled</4> ~<parameter|labeled-5>renamed</5>:<parameter|labeled-6>local</6> (<parameter|-7>left</7>, <parameter|-8>right</8>) =
    ...
    module type <interface|-61>S</61> = sig
      val <function|declaration-62>f</62> : <parameter|labeled-63>labeled</63>:<type|defaultLibrary-64>int</64> -> ?<parameter|optional-65>optional</65>:<type|defaultLibrary-66>string</66> -> <type|defaultLibrary-67>float</67> -> <type|defaultLibrary-68>unit</68>
    end
    |}]
;;
