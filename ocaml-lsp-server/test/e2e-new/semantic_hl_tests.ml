...
module type S = sig
  ...
  [%expect
    ...
    module type <interface|-61>S</61> = sig
      val <function|declaration-62>f</62> : <parameter|labeled-63>labeled</63>:<type|-64>int</64> -> ?<parameter|optional-65>optional</65>:<type|-66>string</66> -> <type|-67>float</67> -> <type|-68>unit</68>
    end
    |}]
;;
